  ...
  useEffect(() => {
    ...
    const unsubFlats = onSnapshot(query(collection(db, "communities", communityId, "flats")), async (snap) => {
      ...
      try {
        ...
        const limitKeys = ["seatsTotal", "panelSeats", "panelSeatsLimit", "seats", "seatsLimit", "totalSeats", "maxSeats", "purchasedSeats", "seatsPurchased", "flatsLimit", "localsLimit", "localiLimit", "unitsLimit", "licenses", "seatCount"];
