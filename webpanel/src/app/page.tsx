...
export default function DashboardPage() {
  ...
  const genJoinCode = async () => {
    ...
    const res = await callable("createJoinCode")({
      communityId,
      role: "ACCOUNTANT",
    });

    const code = (res as any)?.data?.code ?? "";
    setJoinCode(String(code));
  };
    ...
    <RequireAuth roles={["MASTER", "ADMIN", "ACCOUNTANT"]}>
      ...
      <div className="grid">
        ...
        <Tile
          ...
          icon={<IconShield />}
          title="Płatności / SSO"
          desc="Panel płatności (WebView + token SSO)."
        />
      </div>
      ...
      <div style={{ display: "grid", gap: 16, maxWidth: 980 }}>
        <div className="card">
          ...
          <p>
            Aplikacja Android czyta{" "}
            <code>communities/{communityId || "..."}/paymentsUrl</code> i otwiera
            WebView.
          </p>
          ...
          <div className="formRow">
            <input
              className="input"
              placeholder="np. https://panel.e-lokator.org/sso"
              value={paymentsUrl}
        ...
        {(role === "MASTER" || role === "ADMIN") && (
          <div className="card">
            ...
            <p>
              Wygeneruj kod (join code) i przekaż księgowej. Księgowa rejestruje
              się w panelu.
            </p>
        ...
        {(role === "MASTER" ||
          ...
          <div className="card">
            ...
            <p>
              Na MVP tryb MOCK generuje przykładowe faktury. Tryb REAL to
              integracja z KSeF.
            </p>
            ...
            <div className="formRow">
              <select
                ...
                value={ksefMode}
                onChange={(e) =>
                  setKsefMode(e.target.value as "MOCK" | "REAL")
                }
              >
              ...
              <input
                className="input"
                placeholder="Identyfikator (np. NIP wspólnoty)"
                value={ksefId}
